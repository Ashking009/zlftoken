(function (t, e) {
  "use strict";
  var i = (t.mainwebsite = t.mainwebsite || t);
  if (!i.MouseHover) {
    var s,
      n,
      r,
              ...
              u = ("main_web." + s).split("."),
                ...
                a &&
                  ...
                  "function" == typeof define && define.amd
                    ? define((t.MyAMDPath ? t.MyAMDPath + "/" : "") +
    ...
    if (
      ...
      for (r in p)
        p[r].func ||
          t.console.log("GSAP encountered missing dependency: main_web." + r);
    }
    o = !1;
  }
})(
  ...
  _gsScope._gsDefine(
    ...
    function (t) {
      var e,
        i,
        s,
        r = _gsScope.mainwebsite || _gsScope,
        n = r.main_web,
        a = 2 * Math.PI,
        o = Math.PI / 2,
        h = n._class,
...
!(function () {
  function n() {
    (s = window.innerWidth),
      ...
      (g = { x: s / 2, y: u / 2 }),
      (w = document.getElementById("large-hero")),
      (w.style.height = u + "px"),
      ...
      (h = f.getContext("2d")),
      (v = []);
    for (var n = 0; s > n; n += s / 20)
      for (var e = 0; u > e; e += u / 20) {
        var t = n + (Math.random() * s) / 20,
          i = e + (Math.random() * u) / 20,
    ...
    for (var a in v) {
      var M = new d(v[a], 2 + 2 * Math.random(), "rgba(0,0,0,1)");
      v[a].circle = M;
    }
  }
  function e() {
  ...
  function r() {
    if (y) {
      h.clearRect(0, 0, s, u);
      for (var n in v)
        Math.abs(m(g, v[n])) < 500
          ? ((v[n].active = 0.3), (v[n].circle.active = 0.6))
          : Math.abs(m(g, v[n])) < 8e3
          ? ((v[n].active = 0.1), (v[n].circle.active = 0.3))
          : Math.abs(m(g, v[n])) < 2e4
          ? ((v[n].active = 0.02), (v[n].circle.active = 0.1))
          : ((v[n].active = 0), (v[n].circle.active = 0)),
          l(v[n]),
          v[n].circle.draw();
    }
  ...
  function c(n) {
    MouseHover.to(n, 1 + 1 * Math.random(), {
  ...
  function l(n) {
    if (n.active)
      for (var e in n.closest)
        h.beginPath(),
          h.moveTo(n.x, n.y),
          h.lineTo(n.closest[e].x, n.closest[e].y),
          (h.strokeStyle = "rgba(245,255,250," + n.active + ")"),
          h.stroke();
  }
  function d(n, e, t) {
    var i = this;
    !(function () {
      ...
      (this.draw = function () {
        i.active &&
          (h.beginPath(),
          h.arc(i.pos.x, i.pos.y, i.radius, 0, 2 * Math.PI, !1),
          (h.fillStyle = "rgba(87,106,120," + i.active + ")"),
          h.fill());
      });
  }
  function m(n, e) {
